...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by Agent Piya",
            "type": "select",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by Agent Piya",
    ...
    browser_model_section: SettingsSection = {
        ...
        "description": "Settings for the web browser model. Agent Piya uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> agentic framework to handle web interactions.",
    ...
    auth_section: SettingsSection = {
        ...
        "description": "Settings for authentication to use Agent Piya Web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    api_keys_section: SettingsSection = {
        "id": "api_keys",
        "title": "API Keys",
        "description": "API keys for model providers and services used by Agent Piya. You can set multiple API keys separated by a comma (,). They will be used in round-robin fashion.<br>For more information abou Agent Piya Venice provider, see <a href='http://agent-piya.ai/?community/api-dashboard/about' target='_blank'>Agent Piya Venice</a>.",
    ...
    memory_fields.append(
        {
            ...
            "description": "Agent Piya will automatically recall memories based on convesation context.",
            "type": "switch",
    ...
    mcp_client_section: SettingsSection = {
        ...
        "description": "Agent Piya can use external MCP servers, local or remote as tools.",
   ...
   # Secrets section
    ...
    mcp_server_fields.append(
        {
            ...
            "description": "Expose Agent Piya as an SSE/HTTP MCP server. This will make this A0 instance available to MCP clients.",
            "type": "switch",
    ...
    mcp_server_section: SettingsSection = {
        "id": "mcp_server",
        "title": "A0 MCP Server",
        "description": "Agent Piya can be exposed as an SSE MCP server. See <a href=\"javascript:openModal('settings/mcp/server/example.html')\">connection example</a>.",
    ...
    a2a_fields.append(
        {
            ...
            "description": "Expose Agent Piya as A2A server. This allows other agents to connect to A0 via A2A protocol.",
            "type": "switch",
    ...
    a2a_section: SettingsSection = {
        "id": "a2a_server",
        "title": "A0 A2A Server",
        "description": "Agent Piya can be exposed as an A2A server. See <a href=\"javascript:openModal('settings/a2a/a2a-connection.html')\">connection example</a>.",
        "fields": a2a_fields,
        "tab": "mcp",
    }
    ...
    external_api_fields.append(
        {
            ...
            "title": "API Examples",
            "description": "View examples for using Agent Piya's external API endpoints with API key authentication.",
            "type": "button",
    ...
    external_api_section: SettingsSection = {
        "id": "external_api",
        "title": "External API",
        "description": "Agent Piya provides external API endpoints for integration with other applications. "
    ...
    update_checker_fields.append(
        {
            ...
            "description": "Enable update checker to notify about newer versions of Agent Piya.",
            "type": "switch",
    ...
    backup_section: SettingsSection = {
        ...
        "description": "Backup and restore Agent Piya data and configurations "
