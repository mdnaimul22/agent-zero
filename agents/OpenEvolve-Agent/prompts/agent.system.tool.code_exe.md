...
```json
{
    ...
    "tool_name": "view_file",
    "tool_args": {
        "absolute_path": "/a0/usr/projects/vpn_app/test.py"
    }
}
```
...
```json
{
    ...
    "tool_args": {
        "search_path": "/a0/usr/projects/game/",
...
```json
{
    ...
    "tool_args": {
        "search_directory": "/a0/usr/projects/alarm_app/",
        "pattern": "*.py",
        "type": "file",
        "max_depth": 5,
        "extensions": ["py", "js"],
...
```json
{
    ...
    "tool_name": "list_dir",
    "tool_args": {
        "directory_path": "/a0/usr/projects/project_name/"
    }
}
```
...
```json
{
    ...
    "tool_args": {
        "target_file": "/a0/usr/projects/project_name/main.py",
...
```json
{
    ...
    "tool_args": {
        "target_file": "/a0/usr/projects/example_project_name/test.py",
...
```json
{
    ...
    "tool_name": "line_replace",
    "tool_args": {
        "target_file": "/a0/usr/projects/project_name/test.py",
...
```json
{
    ...
    "tool_name": "line_replace",
    "tool_args": {
        "target_file": "/a0/usr/projects/example/test.py",
        "search": "if len(arr) > 0:\n    return arr[len(arr)]",
