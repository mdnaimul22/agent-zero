...
- **No project** uses the empty project key and starts pinned first within the default pinned order; its pin action stays available, and explicit manual ordering still applies within the pinned group.
