...
- `name`: optional label for the child context, shown in listings; defaults to a short task label for new children; when continuing a child, a non-empty name updates its label
