...
class BackupService:
    ...
    def get_default_backup_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "backup_name": f"agent-piya-backup-{timestamp[:10]}",
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes Agent Piya project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up Agent Piya root path with the current Agent Piya root path
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up agent piya root
    ...
    async def create_backup(
        ...
        backup_name: str = "agent-piya-backup"
    ) -> str:
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up agent piya root
