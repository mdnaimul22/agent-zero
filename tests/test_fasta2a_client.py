...
def print_troubleshooting():
    ...
    print("   - Make sure Agent Piya is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Agent Piya server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Agent Piya server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Agent Piya server if not running")
