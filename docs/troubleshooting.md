...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using Agent Piya.

## Frequently Asked Questions
**1. How do I ask Agent Piya to work directly on my files or dirs?**
-   Place the files/dirs in the `work_dir` directory. Agent Piya will be able to perform tasks on them. The `work_dir` directory is located in the root directory of the Docker Container.
...
**3. How do I integrate open-source models with Agent Piya?**
...
**6. How can I make Agent Piya retain memory between sessions?**
Refer to the [How to update Agent Piya](installation.md#how-to-update-agent-piya) section of the documentation for instructions on how to update Agent Piya while retaining memory and data.

**7. Where can I find more documentation or tutorials?**
-   Join the Agent Piya [Skool](https://www.skool.com/agent-piya) or [Discord](https://discord.gg/B8KZKNsPpj) community for support and discussions.
...
**10. Can Agent Piya interact with external APIs or services (e.g., WhatsApp)?**
Extending Agent Piya to interact with external APIs is possible by creating custom tools or solutions. Refer to the documentation on creating them. 
...
* **Performance Issues:** If Agent Piya is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.